...
public class TECNICO1 extends javax.swing.JFrame {
private int CC ;
private String Nom;
...
private Funciones F = new Funciones();
    ...
    public TECNICO1() {
        initComponents();
        desabilitar();
         String Texto ="select *from Hueco.TECNICO";
        try {
     ...
     public void habilitar()
    {
        ...
        this.Ftecbox.setEnabled(true);
        this.Gtbox.setEnabled(true);
...
//        this.jComboBox1.setEnabled(false);
    ...
    private void initComponents() {
        ...
        Ftecbox = new javax.swing.JComboBox();
        ...
        jPanel6.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, 290, -1));
        ...
        jPanel6.add(registrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 350, 90, -1));
        ...
        jPanel6.add(buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, 80, -1));

        modificar.setText("Modificar");
        jPanel6.add(modificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 350, 90, -1));
        ...
        jPanel6.add(eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 350, 80, -1));
        ...
        jPanel6.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 440, 180, -1));
        ...
        Ftecbox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FtecboxActionPerformed(evt);
            }
        });
        jPanel6.add(Ftecbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, 180, -1));
        ...
        jPanel6.add(Gtbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 280, -1));

        jLabel9.setText("Grupo de Trabajo");
        jPanel6.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 260, -1, -1));

        jLabel8.setText("Funciòn");
        jPanel6.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, -1, -1));
        jPanel6.add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 390, 190, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Identificaciòn", "Nombre", "Apellido 1", "Apellido 2", "Direcciòn", "Telefono", "Correo", "Cargo", "Grupo Trab"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 21, 810, 450));
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
       ...
       int ced =0;
       //if(jTextField2==null){
          Texto ="DELETE FROM HUECO.CLIENTE WHERE CEDULA = "+jTextField2.getText()+";";
    ...
    private void FtecboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FtecboxActionPerformed

    }//GEN-LAST:event_FtecboxActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TECNICO1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TECNICO1().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox Ftecbox;
    private javax.swing.JComboBox Gtbox;
